...
# Adult weighted events and totals
adult_placebo_eff_r <- a * adult_placebo_r
adult_placebo_eff_n <- a * adult_placebo_n
adult_drug_eff_r <- a * adult_drug_r
adult_drug_eff_n <- a * adult_drug_n

# Posterior parameters
alpha_post_placebo <- ped_placebo_r + adult_placebo_eff_r + 1
beta_post_placebo <- ped_placebo_n - ped_placebo_r + adult_placebo_eff_n - adult_placebo_eff_r + 1
alpha_post_drug <- ped_drug_r + adult_drug_eff_r + 1
beta_post_drug <- ped_drug_n - ped_drug_r + adult_drug_eff_n - adult_drug_eff_r + 1
